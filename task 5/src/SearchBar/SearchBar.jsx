...
function SearchBar(props) {
    ...
    async function getMovies() {
        const fetchedMovies = await fetch(`http://localhost:3004/movies`).then(
    ...
    useEffect(() => {
        (async () => {
            ...
            console.log("При получении фильмов произошла ошибка");
        });
    }, []);
            ...
            <div className="wrapper-1">
                <div className="wrapper-2">
                    ...
                    <button
                        ...
                        onClick={() => {
                            movies && searchByName(searchString);
                        }}
                    >
                        Поиск
                    </button>
                    ...
                    moviesToShow.map((movie) => (
                        ...
                        >
                            <MovieBar
                                ...
                                isSelected={
                                    Number(movie.id) === Number(props.movieId)
                                }
                                title={movie.title}
                                year={movie.year}
                                genres={movie.genres}
